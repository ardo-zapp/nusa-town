...
export function sitAction(player: Pony, game: PonyTownGame) {
	if (canPonySit(player, game.map) && (game.send(server => server.action(Action.Sit)) as any)) {
...
export function standAction(player: Pony, game: PonyTownGame) {
	if (canPonyStand(player, game.map) && (game.send(server => server.action(Action.Stand)) as any)) {
...
export function lieAction(player: Pony, game: PonyTownGame) {
	if (canPonyLie(player, game.map) && (game.send(server => server.action(Action.Lie)) as any)) {
...
export function flyAction(player: Pony, game: PonyTownGame) {
	if (canPonyFlyUp(player) && (game.send(server => server.action(Action.Fly)) as any)) {
...
export function boopAction(game: PonyTownGame) {
	if (game.player && canBoop(game.player) && (game.send(server => server.action(Action.Boop)) as any)) {
...
export function turnHeadAction(game: PonyTownGame) {
	...
	if ((game.send(server => server.action(Action.TurnHead)) as any)) {
